...
<html>
    ...
    <body>
        <div class="header">
            <div style="font-size: 40px;color:white">Controlo de Horas Extras dos Funcionários</div>
        </div><br><br> 
        <div class="content">
                <p class="titulo">Autenticação</p>                    <br>
            <div class="content2">
                <form action="http://localhost/hextras/public/login" method="POST">
                    <input type="text" name="utilizador" value="" placeholder="Utilizador">
                                                                      <br>
